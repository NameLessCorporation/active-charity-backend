...
func (o *OrganizationEndpoint) RejectTransferCoinsV1(ctx context.Context, req *organization.RejectTransferCoinsV1Request) (*organization.RejectTransferCoinsV1Response, error) {
	...
	if err = o.operations.RejectTransferCoinsToOrganization(ctx, req.GetTransactionId()); err != nil {
		return nil, err
	}

	return &organization.RejectTransferCoinsV1Response{}, nil
}
